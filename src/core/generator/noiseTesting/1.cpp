...
//     float dot00 = dotProduct(gradientVectors[hash1(x0, y0) % 4][0], gradientVectors[hash1(x0, y0) % 4][1], x, y);
//     float dot01 = dotProduct(gradientVectors[hash1(x0, y1) % 4][0], gradientVectors[hash1(x0, y1) % 4][1], x, y - 1);
//     float dot10 = dotProduct(gradientVectors[hash1(x1, y0) % 4][0], gradientVectors[hash1(x1, y0) % 4][1], x - 1, y);
//     float dot11 = dotProduct(gradientVectors[hash1(x1, y1) % 4][0], gradientVectors[hash1(x1, y1) % 4][1], x - 1, y - 1);
